...
class DeepLabCE(torch.nn.Module):
    ...
    Reference: https://github.com/tensorflow/models/blob/bd488858d610e44df69da6f89277e9de8a03722c/research/deeplab/utils/train_utils.py#L33 # noqa E501
    Arguments:
...
def _neg_loss(pred, gt, weight):
    ...
    neg_loss = (
        torch.log(1 - pred) * torch.pow(pred, 2) * neg_weights * neg_inds * weight
    )
