...
class PoseHighResolutionNet(nn.Module):
    ...
    def forward(self, x, seg_map=None, label=None, point_list=None, target_shape=None):
        ...
        for head in self.heads:
            ...
            results[head] = torch.nn.functional.interpolate(
                results[head], size=target_shape, mode="bilinear", align_corners=False
            )
...
def hrnet32(args):
    heads = {"seg": args.num_classes + 1, "center": args.num_classes, "offset": 2}
